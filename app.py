...
names = ['ALBATROSS','AMARANTA OCRE','AVETORO AMERICANO','AVOCETA AMERICANA','BISBITA AMERICANO',
         'CANDELITA NORTEÑA','CERNICALO AMERICANO','COTORRA ALEJANDRINA','FOCHA AMERICANA','JILGUERO AMERICANO']
